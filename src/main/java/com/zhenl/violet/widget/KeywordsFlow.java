...
public class KeywordsFlow extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private boolean show() {
        if (width > 0 && height > 0 && vecKeywords != null
            ...
            LinkedList<CircleView> listTxtTop = new LinkedList<>();
            LinkedList<CircleView> listTxtBottom = new LinkedList<>();
            for (int i = 0; i < size; i++) {
                ...
                txv.setTag(R.id.center, keyword);
                txv.setOnClickListener(listener);
                txv.setText(keyword.getText());
                txv.setTextColor(getResources().getColorStateList(R.color.color_keyword_text));
                int dp8 = DensityUtil.dp2px(getContext(), 8);
                int dp6 = DensityUtil.dp2px(getContext(), 6);
                txv.setPadding(dp8, dp6, dp8, dp6);
                txv.setSingleLine(true);
                Paint paint = txv.getPaint();
                int strWidth = (int) Math.ceil(paint.measureText(keyword.getText()));
    ...
    static class CircleView extends AppCompatTextView {
    ...
    public interface OnItemClickListener {
        void onItemClick(Keyword keyword, boolean isSelected);
    }
    ...
    private OnClickListener listener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (itemClickListener != null) {
                itemClickListener.onItemClick((Keyword) v.getTag(R.id.center), isSelected);
            }
        }
    };
}
