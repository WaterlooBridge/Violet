 ...
 * 加载更多基类
 */
open class BaseLoadMoreModule(private val baseQuickAdapter: BasePagedListAdapter<*>) {
    ...
    val loadMoreViewPosition: Int
        get() {
            ...
            return baseQuickAdapter.let {
                it.headerLayoutCount + it.getDefItemCount() + it.footerLayoutCount
            }
        }
    ...
    fun hasLoadMoreView(): Boolean {
        ...
        return baseQuickAdapter.getDefItemCount() != 0
    }
