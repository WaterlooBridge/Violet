...
import com.zhenl.violet.media.CustomAlertDialog;
import com.zhenl.violet.utils.StorageType;
import com.zhenl.violet.utils.StorageUtil;
...
public class PickImageHelper {
    ...
    public static class PickImageOption {
         ...
         * 图片选择保存路径
         */
        public String outputPath = StorageUtil.getWritePath(System.currentTimeMillis() + ".jpg", StorageType.TYPE_TEMP);
    }
